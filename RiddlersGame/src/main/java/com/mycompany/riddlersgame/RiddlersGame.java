    ...
    */
    ...
    if (currentQuestionIndex < questions.size()) {
        ...
        if (selectedAnswer.equals(question.getAnswer())) {
            ...
            playSound("/sfx/correctsoundfx.wav");
            ...
            playSound("/sfx/incorrectsoundfx.wav");
            removeAnswerButtonListeners();
        }
    ...
    private void updateUI() {
        ...
        scoreLabel.setText(Integer.toString(scores));
    }
    ...
    private void initComponents() {
        ...
        homeButton.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/images/homebutton dark.png"))); // NOI18N
        ...
        hintButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/hintbutton.png"))); // NOI18N
        hintButton.setBorder(null);
        hintButton.setBorderPainted(false);
        hintButton.setContentAreaFilled(false);
        hintButton.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/images/darkhintbutton.png"))); // NOI18N
        ...
        backgroundPanel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/playpagebackground.jpg"))); // NOI18N
